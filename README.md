...
Also note that this project focuses only on two-dimensional, escape-time fractals like the Mandelbrot set and the Julia set. A pretty clear definition of such a fractal is that given by [Tom Van Cutsem](http://soft.vub.ac.be/~tvcutsem/teaching/wpo/grafsys/ex5/les5.html):
...
* __Representation__. Any possible rendering method/algorithm. To better explain what means using a certain representation instead of another, look at these examples:
  ![Tangent circles](http://mbilotta.altervista.org/wp-content/uploads/2015/02/rep4.png "Tangent circles")
  ![Escape time](http://mbilotta.altervista.org/wp-content/uploads/2015/02/rep2.png "Escape time")
  ![Mu-Ency](http://mbilotta.altervista.org/wp-content/uploads/2015/02/rep3.png "Mu-Ency")
  ![Ring segments](http://mbilotta.altervista.org/wp-content/uploads/2015/02/rep1.png "Ring segments")
